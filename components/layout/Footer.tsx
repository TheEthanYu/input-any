...
const companyLinks: FooterLink[] = [
  { href: 'https://twitter.com/TheEthanYu', label: 'Twitter', external: true },
  { href: 'https://github.com/TheEthanYu', label: 'GitHub', external: true },
]
          ...
          <div className="grid grid-cols-2 md:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="col-span-2 md:col-span-4 lg:col-span-5">
              ...
              <p className="mt-4 text-sm text-foreground/75 leading-relaxed">
                Code Less, Ship More. Build and launch your SaaS faster with our
          ...
          <div className="mt-12 pt-6 border-t border-muted">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <p className="text-sm text-foreground/75">
                © {new Date().getFullYear()} ShipOneDay. All rights reserved.
              </p>
              <div className="flex items-center space-x-4">
                <Link
                  href="https://twitter.com/TheEthanYu"
                ...
                <Link
                  href="https://github.com/TheEthanYu"
                  className="text-foreground/75 hover:text-foreground transition-colors"
                  target="_blank"
                  rel="noopener noreferrer"
                >
